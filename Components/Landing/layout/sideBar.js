...
export default function SideBar({active,type}) {
  return (
            ...
            <div className='w-full flex flex-col gap-10 pt-5'>
                ...
                <div className="py-4 mt-8 flex flex-col justify-between">
                    <ul className="flex flex-col gap-2">
                        ...
                        <Link href='/farmer/myproducts' ><li className={`${active === 1 && 'bg-[#4BA064] text-white'} text-lg p-2 px-6`}>{type && "My products"}{!type && "Products"}</li></Link>
                        <Link href='/farmer/advices' ><li className={`${active === 2 && 'bg-[#4BA064] text-white'} text-lg p-2 px-6`}>{type && "Advices"}{!type && "Lists of Farmers"}</li></Link>
